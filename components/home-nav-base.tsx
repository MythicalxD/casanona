...
const HomeNavBase = () => {
  return (
    <div className="flex flex-col">
      <div className="bg-white relative md:block hidden z-20">
        <div className="w-full h-full flex flex-grow items-center relative px-8">
          <a href="/" className="ml-4 cursor-pointer block">
            <img className="w-[120px] h-[60px]" alt="logo" src="/logo.svg" />
          </a>

          <div className="flex flex-grow"></div>
          <div className="gap-x-8 justify-center text-[#626262] text-md font-semibold md:flex hidden">
            <Link href="/" passHref>
              Home
            </Link>
